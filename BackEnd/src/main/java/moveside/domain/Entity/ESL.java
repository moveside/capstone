...
public class ESL {
    ...
    @Builder
    public ESL(Long id,String openTime,String closeTime,String breakTime1,String breakTime2,String exp,String menuName1,String menuName2,String menuCost1,String menuCost2){
        this.id=id;
